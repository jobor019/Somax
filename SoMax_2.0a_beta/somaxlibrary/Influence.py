...
class AbstractInfluence(ABC):
    ...
    def __init__(self, event: CorpusEvent, time_of_influence: float, transform: AbstractTransform, **_kwargs):
        self.event: CorpusEvent = event
        self.time_of_influence: float = time_of_influence
        self.transforms: AbstractTransform = transform


class ClassicInfluence(AbstractInfluence):

    def __init__(self, event: CorpusEvent, time_of_influence: float, transform: AbstractTransform, **_kwargs):
        super(ClassicInfluence, self).__init__(event, time_of_influence, transform)
